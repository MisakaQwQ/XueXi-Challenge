...
from ocr.hyperparams.cn_hyperparams import CnHyperparams as Hyperparams
from ocr.fit.lstm import init_states
from ocr.fit.ctc_metrics import CtcMetrics
from ocr.data_utils.data_iter import SimpleBatch
from ocr.symbols.crnn import crnn_lstm
from ocr.utils import read_charset, normalize_img_array
from ocr.line_split import line_split
...
class CnOcr(object):
    MODEL_FILE_PREFIX = 'model-v1.0.0'

    def __init__(self):
        # self._model_dir = os.path.join(root, 'models')
        self._model_dir = 'ocr\\models'
        self._model_epoch = 20
